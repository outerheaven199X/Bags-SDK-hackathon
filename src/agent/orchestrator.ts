...
const ROUTINE_PATTERNS = [
  /claim/i, /balance/i, /check/i, /list/i, /monitor/i, /status/i,
  /positions/i, /feed/i, /quote/i,
];

const STRATEGIC_PATTERNS = [
  /evaluate/i, /analyze/i, /recommend/i, /compose.*config/i,
  /should/i, /optimize/i, /compare/i, /strategy/i, /report/i,
];
